...
***This Repo contains the things I push to it for SLU CS course classwork!***
...
<ul>
  <li>Intro to CS (hs)</li>
  <li>Intro to Game programming (hs)</li>
  <li>a tad of Lua</li>
  <li>General computer knowledge first half of life on Mac and Windows Vista and second half on Windows 7/10/11</li>
</ul>
